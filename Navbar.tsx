...
import { ShoppingCart, Code2, Search, Bell, User, Globe, Shield } from 'lucide-react';
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4 sm:space-x-6">
            ...
            <button 
              ...
              className="hidden lg:flex items-center space-x-1 text-xs font-bold text-slate-500 hover:text-purple-400 transition-colors"
              title={t.admin}
            >
